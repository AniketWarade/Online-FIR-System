...
$sql = "SELECT FIRNumber,FIRType,ComplainerName,Phone,District,City,PoliceStation,Address,CrimeDate,CrimeTime,CrimeLocation,CrimeDescription,Status,Report FROM firregister where Status='Closed'";
