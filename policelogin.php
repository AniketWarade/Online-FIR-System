...
if(isset($_POST['Login']))
{
	...
	$sql="Select * from policeregister where UserName='$User' AND Password='$Pass'";
	...
	{	
        ...
        $t = date("h:i:sa");
        $s = "INSERT INTO policelogin (UserName, IPAddr, HostName, UserDate, UserTime) VALUES ('$User', '$ip', '$hostname', '$d', '$t')";
        if (mysqli_query($con,$s))
        {
            ...
            $url='..\Online FIR System\Managecomplaints.php';
	...
	else
	{
		...
		$url='..\Online FIR System\Policeadminlogin.php';
		echo '<META HTTP-EQUIV=REFRESH CONTENT="1; '.$url.'">';
	}
}
?>