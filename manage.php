...
$sql = "SELECT FIRNumber,FIRType,ComplainerName,Phone,District,City,PoliceStation,Address,CrimeDate,CrimeTime,CrimeLocation,CrimeDescription,Status,Report FROM firregister where Status = 'New' OR Status = ''";
...
if(isset($_POST['Find']))
{
    ...
    if($find_Result)
    {
        ...
        {
            echo "No Data for this FIR Number";
        }
    }
    else
    {
